...
RANDOM_SEED_OVERLAYS = {
    ...
    #     },
    # ),
    "shield-amip-1deg-data-size-8yr-1yr-inference-81yr-RS0-IC0": (
        "01JD24T5JPSTJBN2PZNJFVKGSM",
        {
            "n_forward_steps": 118341,
            "loader": {
                "start_indices": {"times": ["1940-01-01T12:00:00"]},
    ...
    "shield-amip-1deg-data-size-8yr-1yr-inference-81yr-RS0-IC1": (
        "01JD24T5JPSTJBN2PZNJFVKGSM",
        {
            "n_forward_steps": 118341,
            "loader": {
    ...
    "shield-amip-1deg-data-size-8yr-1yr-inference-81yr-RS0-IC2": (
        "01JD24T5JPSTJBN2PZNJFVKGSM",
        {
            "n_forward_steps": 118341,
            "loader": {
    ...
    "shield-amip-1deg-data-size-8yr-1yr-inference-81yr-RS2-IC0": (
        "01JD423AX7C7M27ZKH81FYV3KS",
        {
            "n_forward_steps": 118341,
            "loader": {
                "start_indices": {"times": ["1940-01-01T12:00:00"]},
    ...
    "shield-amip-1deg-data-size-8yr-1yr-inference-81yr-RS2-IC1": (
        "01JD423AX7C7M27ZKH81FYV3KS",
        {
            "n_forward_steps": 118341,
            "loader": {
    ...
    "shield-amip-1deg-data-size-8yr-1yr-inference-81yr-RS2-IC2": (
        "01JD423AX7C7M27ZKH81FYV3KS",
        {
            "n_forward_steps": 118341,
            "loader": {
